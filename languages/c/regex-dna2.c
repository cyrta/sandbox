...
/*
 ...
 http://benchmarksgame.alioth.debian.org/u64q/program.php?test=regexdna&lang=gcc&id=1


/usr/bin/gcc -pipe -Wall -O3 -fomit-frame-pointer -march=native -pthread -I/usr/include/tcl8.4 `pkg-config --cflags --libs glib-2.0` regexdna.c -o regexdna.gcc_run -ltcl8.4 -lglib-2.0
rm regexdna.c
0.44s to complete and log all make actions

COMMAND LINE:
./regexdna.gcc_run 0 < regexdna-input5000000.txt
